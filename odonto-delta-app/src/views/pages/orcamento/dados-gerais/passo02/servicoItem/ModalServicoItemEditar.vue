<template>
    <div>
        <confirm-modal
                ...
                :persistencia="false"
                mensagemInicial="Deseja realmente excluir o serviço "
                :mensagemMeio="item.servico.descricao"
                mensagemFinal="?"/>
        <v-dialog v-model="value" max-width="700" scrollable persistent>
            <v-card elevation="4" tile>
                <v-toolbar dark color="primary" elevation="0">
                    <v-toolbar-title>Editando o serviço <b>{{item.servico.descricao}}</b></v-toolbar-title>
                    <v-spacer/>
