    ...
    <container-component>
        <form-table style="padding: 0px; padding-right: 20px">
            <v-data-table
                    ...
                    :loading="false"
                    no-data-text="Não há peças adicionadas"
                    class="table-list"
                    hide-default-footer>
                ...
                <template v-slot:item.peca.descricao="{item}">
                    <span class="d-inline-block text-truncate max-210">{{ item.peca.descricao | textoSemValor }}</span>
                </template>
                ...
                <template v-slot:item.acoes="{item}">
                    <botao-editar color="grey" @editar="editarPeca(item)"/>
                </template>
            </v-data-table>
