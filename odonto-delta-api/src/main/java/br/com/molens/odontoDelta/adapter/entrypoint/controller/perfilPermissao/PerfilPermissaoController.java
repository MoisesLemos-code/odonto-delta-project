...
public interface PerfilPermissaoController {
    ...
    ResponseEntity<Void> atualizar(@RequestBody @Valid AtualizarPerfilPermissaoInput input);
    ...
    ResponseEntity<BuscarPermissoesPorPerfilOutput> buscarPerfilPermissoesPorPerfil(@PathVariable Long perfilId);
